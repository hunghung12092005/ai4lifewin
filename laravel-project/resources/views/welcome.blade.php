...
<!-- Mirrored from html.vecurosoft.com/toddly/demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Aug 2025 03:00:50 GMT -->
    ...
    <div class="vs-menu-wrapper">
        <div class="vs-menu-area text-center">
                ...
                <ul>
                    <li class="menu-item-has-children">
                        <a class="vs-svg-assets" href="index.html">
                            HOME
                            <svg xmlns="http://www.w3.org/2000/svg" width="87" height="31"
                                viewBox="0 0 87 31" fill="none">
                                <path
            ...
            <div class="px-20 py-20">
                ...
                <p class="sidemenu-text sidemenu-text--footer text-center mb-0">Copyright © 2025 <a
                        class="vs-theme-color" href="index.html">Toddly</a>.
                    All
                    rights reserved.
                </p>
            </div>
 ...
 ============================== -->
                    ...
                    <div class="row justify-content-between align-items-center">
                        <div class="col">
                            <div class="vs-header__logo">
                                <a href="index.html"><img src="assets/img/logo.svg" alt="Toddly"
                                        class="logo"></a>
                            </div>
                        </div>
                        <div class="col-auto">
    ...
    <main class="vs-main">
                        ...
                        <div class="container container--custom">
                            <div class="vs-hero__content">
                                <div class="vs-hero__shape">
                                    <div class="vs-hero__shape--bg vs-hero__anim"
                                        data-bg-src="assets/img/hero/hero-shape-1.svg"></div>
                                    ...
                                    <img class="vs-hero__character vs-hero__anim"
                                        src="assets/img/hero/hero-character-1.png" alt="Hero Character">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="vs-service--area animation-active z-index-common space overflow-hidden"
            ...
            <img src="assets/img/elements/service-ele-1.svg" alt="elements1"
                class="vs-service--ele1 wow animate__fadeInLeft" data-wow-delay="0.25s">
            <img src="assets/img/elements/service-ele-2.svg" alt="elements1"
                class="vs-service--ele2 wow animate__fadeInRight" data-wow-delay="0.45s">
            <div class="container">
                <div class="row">
                ...
                <div class="z-index-common">
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="vs-service wow animate__fadeInUp" data-wow-delay="0.25s">
                                    <div class="vs-service__figure">
                                        <a href="service-details.html" class="vs-service__image--link">
                                            <img class="vs-service__image" src="assets/img/service/s-1-1.jpg"
                                                alt="vs service image">
                                        </a>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 swiper-slide">
                                <div class="vs-service wow animate__fadeInUp" data-wow-delay="0.35s">
                                    <div class="vs-service__figure">
                                        <a href="service-details.html" class="vs-service__image--link">
                                            <img class="vs-service__image" src="assets/img/service/s-1-2.jpg"
                                                alt="vs service image">
                                        </a>
                                    </div>
                                    <div class="vs-service__content">
                            ...
                            <div class="col-lg-4 col-md-6 swiper-slide">
                                <div class="vs-service wow animate__fadeInUp" data-wow-delay="0.45s">
                                    <div class="vs-service__figure">
                                        <a href="service-details.html" class="vs-service__image--link">
                                            <img class="vs-service__image" src="assets/img/service/s-1-3.jpg"
                                                alt="vs service image">
                                        </a>
                                    </div>
                                    <div class="vs-service__content">
                            ...
                            <div class="col-lg-4 col-md-6 swiper-slide">
                                <div class="vs-service wow animate__fadeInUp" data-wow-delay="0.55s">
                                    <div class="vs-service__figure">
                                        <a href="service-details.html" class="vs-service__image--link">
                                            <img class="vs-service__image" src="assets/img/service/s-1-4.jpg"
                                                alt="vs service image">
                                        </a>
                                    </div>
                                    <div class="vs-service__content">
                    ...
                    <div class="nav-prev-1">
                        <svg width="57" height="20" viewBox="0 0 57 20" fill="none"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <mask id="mask0_318_7638" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                                width="57" height="20">
                                <rect width="57" height="20" transform="matrix(-1 0 0 1 57 0)"
                                    fill="url(#pattern0_318_7638)" />
                            </mask>
                            <g mask="url(#mask0_318_7638)">
                                <rect width="84" height="42" transform="matrix(-1 0 0 1 70 -14)"
                                    fill="currentColor" />
                            </g>
                            <defs>
                                <pattern id="pattern0_318_7638" patternContentUnits="objectBoundingBox"
                                    width="1" height="1">
                    ...
                    <div class="nav-next-2">
                        <svg width="57" height="20" viewBox="0 0 57 20" fill="none"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <mask id="mask0_318_7635" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                                width="57" height="20">
                            ...
                            <defs>
                                <pattern id="pattern0_318_7635" patternContentUnits="objectBoundingBox"
                                    width="1" height="1">
        ...
        <section class="vs-about--section space space-extra-bottom z-index-common parallax-wrap overflow-hidden"
            ...
            <img src="assets/img/about/vs-about-h1-ele-4.png" alt="elements"
                class="vs-about--ele1 wow animate__fadeInUp" data-wow-delay="0.35s">
            <div class="container">
                    ...
                    <div class="col-lg-6 mb-30 wow animate__fadeInUp" data-wow-delay="0.25s">
                        <div class="vs-about--image">
                            <div class="vs-about--image__figure1 wow animate__fadeInUp" data-wow-delay="0.25s">
                                <img src="assets/img/about/vs-about-h1-1.jpg" alt="about image" width="198"
                                    height="214" loading="lazy">
                            </div>
                            <div class="vs-about--image__figure2 wow animate__fadeInUp" data-wow-delay="0.35s">
                                <img src="assets/img/about/vs-about-h1-2.jpg" alt="about image" width="400"
                            ...
                            <div class="vs-about--story">
                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="history-tab" data-bs-toggle="tab"
                                                ...
                                                aria-controls="history-tab-pane" aria-selected="true">
                                                our history
                                            </button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="history-tab-pane" role="tabpanel"
                                        ...
                                        <p class="vs-about__text vs-text">Pre-school has open door and also offer free
                                            trial sessios that
                                            child
                                            Creative Learning
                                            Opportunity For Kids Hised sedaugue felis Phasellus gravida lacus quis eros.
                                        </p>
                                        <ul class="vs-list pt-15 mb-35">
                                            <li>Learning Opportunity For Kids</li>
                                            <li>Your Child Will Take</li>
                                        </ul>
                                        <a href="contact.html" class="vs-btn"><span
                                                class="vs-btn__border"></span>contact us</a>
                                    </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-7 wow animate__fadeInUp" data-wow-delay="0.15s">
                        <div class="vs-title text-center title-anime animation-style2">
                            <div class="title-anime__wrap">
                                <span class="vs-title__sub text-white">Ngành đào tạo</span>
                                <h2 class="vs-title__main text-white px-xl-5">
                                    Danh sách ngành học
                                </h2>
                            </div>
                        </div>
                            ...
                            @foreach ($majors as $index => $major)
                                <div class="col-lg-6 wow animate__fadeInUp"
                                    ...
                                    <div class="vs-session">
                                        <img class="vs-session__bg" src="{{ $major->image_url }}" alt="">
                                        <div class="vs-session__content">
                                            <h3 class="vs-session__title">{{ $major->name }}</h3>
                                            <time class="vs-session__time" datetime="08:00">8.00am - 10.00am</time>
                                        </div>
                                        <span class="vs-session__icon">
                                            <img src="{{ $major->image_url }}" alt="session icon">
                                        </span>
                                    </div>
                                </div>
                            @endforeach
            ...
            <div class="container">
                ...
                <div class="vs-gallery--row">
                    <div class="vs-gallery vs-gallery--col1 wow animate__fadeInUp" data-wow-delay="0.25s">
                        <div class="vs-gallery__figure">
                            <a class="vs-gallery__image--link" href="class-details.html">
                                <img class="vs-gallery__image"
                                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQpLM_Cnjvc9sQVqEuL_Skk6ZhutV9yO1MK7Q&s"
                                    alt="Gallery" loading="lazy">
                            </a>
                        </div>
                        <div class="vs-gallery__hover">
                            <a href="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQpLM_Cnjvc9sQVqEuL_Skk6ZhutV9yO1MK7Q&s"
                                class="vs-gallery__icon popup-image">
                    ...
                    <div class="vs-gallery vs-gallery--col2 wow animate__fadeInUp" data-wow-delay="0.35s">
                        <div class="vs-gallery__figure">
                            <a class="vs-gallery__image--link" href="class-details.html">
                                <img class="vs-gallery__image" src="assets/img/gallery/gallery-h1-1-2.jpg"
                                    alt="Gallery" loading="lazy">
                            </a>
                        </div>
                        <div class="vs-gallery__hover">
                    ...
                    <div class="vs-gallery vs-gallery--col3 wow animate__fadeInUp" data-wow-delay="0.45s">
                        <div class="vs-gallery__figure">
                            <a class="vs-gallery__image--link" href="class-details.html">
                                <img class="vs-gallery__image" src="assets/img/gallery/gallery-h1-1-3.jpg"
                                    alt="Gallery" loading="lazy">
                            </a>
                        </div>
                        <div class="vs-gallery__hover">
                    ...
                    <div class="vs-gallery vs-gallery--col4 wow animate__fadeInUp" data-wow-delay="0.55s">
                        <div class="vs-gallery__figure">
                            <a class="vs-gallery__image--link" href="class-details.html">
                                <img class="vs-gallery__image" src="assets/img/gallery/gallery-h1-1-4.jpg"
                                    alt="Gallery" loading="lazy">
                            </a>
                        </div>
                        <div class="vs-gallery__hover">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-auto text-center text-lg-start">
                        <div class="vs-title title-anime animation-style2">
                            ...
                            <p class="text-white fw-bold text-capitalize font-title vs-text-bolder mb-0">work and play
                                come together ?
                            </p>
                        </div>
                    ...
                    <div class="col-lg-7 flex-grow-1">
                        <div class="swiper vs-carousel" data-xl="3" data-space-xl="15" data-md="3"
                            data-sm="2" data-space-lg="5" data-nav-next=".vs-pro--slider__next"
                            data-nav-prev=".vs-pro--slider__prev">
        ...
        <section class="vs-class--area space-extra-top space-extra-bottom z-index-common overflow-hidden"
            ...
            <div class="container">
                ...
                <div class="z-index-common">
                    <div class="vs-carousel vs-carousel--class swiper" data-xl="4" data-lg="3"
                        data-autoplay="false" data-loop="true" data-autoplay-delay="6000"
                        data-nav-next="#swiper-button-next" data-nav-prev="#swiper-button-prev">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide wow animate__fadeInUp" data-wow-delay="0.25s">
                                <div class="vs-class">
                                    <div class="vs-class__figure">
                                        <a class="vs-class__figure--link" href="class-details.html">
                                            <img class="vs-class__figure--img" src="assets/img/class/class-1-1.jpg"
                                                alt="Class Details">
                            ...
                            <div class="swiper-slide wow animate__fadeInUp" data-wow-delay="0.45s">
                                <div class="vs-class">
                                    <div class="vs-class__figure">
                                        <a class="vs-class__figure--link" href="class-details.html">
                                            <img class="vs-class__figure--img" src="assets/img/class/class-1-2.jpg"
                                                alt="Class Details">
                                            <div class="vs-class__icon--wrap">
                            ...
                            <div class="swiper-slide wow animate__fadeInUp" data-wow-delay="0.65s">
                                <div class="vs-class">
                                    <div class="vs-class__figure">
                                        <a class="vs-class__figure--link" href="class-details.html">
                                            <img class="vs-class__figure--img" src="assets/img/class/class-1-3.jpg"
                                                alt="Class Details">
                                            <div class="vs-class__icon--wrap">
                            ...
                            <div class="swiper-slide wow animate__fadeInUp" data-wow-delay="0.85s">
                                <div class="vs-class">
                                    <div class="vs-class__figure">
                                        <a class="vs-class__figure--link" href="class-details.html">
                                            <img class="vs-class__figure--img" src="assets/img/class/class-1-4.jpg"
                                                alt="Class Details">
                                            <div class="vs-class__icon--wrap">
                    ...
                    <div id="swiper-button-prev" class="nav-prev-1">
                        <svg width="57" height="20" viewBox="0 0 57 20" fill="none"
                            ...
                            <mask id="mask0_318_7638" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                                width="57" height="20">
                                <rect width="57" height="20" transform="matrix(-1 0 0 1 57 0)"
                                    fill="url(#pattern0_318_7638)"></rect>
                            </mask>
                            <g mask="url(#mask0_318_7638)">
                                <rect width="84" height="42" transform="matrix(-1 0 0 1 70 -14)"
                ...
                <div class="row justify-content-end">
                    <div class="col-lg-7">
                        <div class="feedback-wrapper">
                            <div
                                class="vs-title vs-title--style2 title-anime animation-style2 text-center text-lg-start">
                                <div class="title-anime__wrap">
                            ...
                            <div class="swiper feedback-slider">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="feedback-block">
                                            <div class="feedback-block__image">
                                                <img src="assets/img/feedback/feedback-man-1-1.jpg" alt="feedback man"
                                                    width="145" height="145">
                                                <div class="feedback-block__icon--quote">
                                                    <img src="assets/img/icons/svg-quote-icon.svg"
                                                        alt="svg-quote-icon">
                                                </div>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="feedback-block">
                                            <div class="feedback-block__image">
                                                <img src="assets/img/feedback/feedback-man-1-2.jpg" alt="feedback man"
                                                    width="145" height="145">
                                                <div class="feedback-block__icon--quote">
                                                    <img src="assets/img/icons/svg-quote-icon.svg"
                                                        alt="svg-quote-icon">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="feedback-block">
                                            <div class="feedback-block__image">
                                                <img src="assets/img/feedback/feedback-man-1-3.jpg"
                                                    alt="feedback man" width="145" height="145">
                                                <div class="feedback-block__icon--quote">
                                                    <img src="assets/img/icons/svg-quote-icon.svg"
                                                        alt="svg-quote-icon">
                                                </div>
                                ...
                                <div class="vs-blog__inner">
                                    <div class="vs-blog__img">
                                        <a href="blog-details.html">
                                            <img src="assets/img/blog/blog-h1-1.jpg" alt="Blog"
                                                loading="lazy">
                                        </a>
                                    </div>
                        ...
                        <div class="col-lg-4 swiper-slide wow animate__fadeInUp" data-wow-delay="0.35s">
                            <div class="vs-blog vs-blog--style2">
                                <div class="vs-blog__inner">
                                    <div class="vs-blog__img">
                                        <a href="blog-details.html">
                                            <img src="assets/img/blog/blog-h1-2.jpg" alt="Blog"
                                                loading="lazy">
                                        </a>
                                    </div>
                                    <div class="vs-blog__content">
                        ...
                        <div class="col-lg-4 swiper-slide wow animate__fadeInUp" data-wow-delay="0.45s">
                            <div class="vs-blog vs-blog--style2">
                                <div class="vs-blog__inner">
                                    <div class="vs-blog__img">
                                        <a href="blog-details.html">
                                            <img src="assets/img/blog/blog-h1-3.jpg" alt="Blog"
                                                loading="lazy">
                                        </a>
                                    </div>
                                    <div class="vs-blog__content">
    ...
    <div class="vs-footer bg-title">
        <div class="vs-footer__top z-index-common space-extra-top space-extra-bottom">
            <img src="assets/img/footer/footer-element-1.png" alt="Footer Element"
                class="vs-footer__ele1 wow animate__fadeInLeft" data-wow-delay="0.25s">
            <img src="assets/img/footer/footer-element-2.png" alt="Footer Element" class="vs-footer__ele2">
            <img src="assets/img/footer/footer-element-3.png" alt="Footer Element"
                class="vs-footer__ele3 wow animate__fadeInRight" data-wow-delay="0.35s">
                        ...
                        <div class="vs-footer__widget">
                            <div class="vs-footer__logo text-center text-md-start mb-25">
                                <a href="index.html" class="vs-footer__logo-link">
                                    <img src="assets/img/logo-version-2.svg" alt="Toddly Logo">
                                </a>
                            </div>
                            ...
                            <div
                                class="social-style social-style--version2 w-100 justify-content-center justify-content-md-start pt-25">
                                <span class="social-style__label">follow us :</span>
                                <a href="#"><i class="fab fa-facebook-f"></i></a>
                                <a href="#"><i class="fab fa-linkedin-in"></i></a>
                                <a href="#"><i class="fab fa-youtube"></i></a>
                    ...
                    <div class="col-lg-4 col-md-6 wow animate__fadeInUp" data-wow-delay="0.45s">
                        <div class="vs-footer__widget">
                            ...
                            <div class="sidebar-gallery">
                                <div class="gallery-thumb">
                                    <img src="assets/img/widget/gal-1-1.jpg" alt="Gallery Image" class="w-100">
                                    <a href="assets/img/widget/gal-1-1-big.jpg" class="popup-image gal-btn"><i
                                            class="fal fa-plus"></i></a>
                                </div>
                                <div class="gallery-thumb">
                                    <img src="assets/img/widget/gal-1-2.jpg" alt="Gallery Image" class="w-100">
                                    <a href="assets/img/widget/gal-1-2-big.jpg" class="popup-image gal-btn"><i
                                            class="fal fa-plus"></i></a>
                                </div>
                                <div class="gallery-thumb">
                                    <img src="assets/img/widget/gal-1-3.jpg" alt="Gallery Image" class="w-100">
                                    <a href="assets/img/widget/gal-1-3-big.jpg" class="popup-image gal-btn"><i
                                            class="fal fa-plus"></i></a>
                                </div>
                                <div class="gallery-thumb">
                                    <img src="assets/img/widget/gal-1-4.jpg" alt="Gallery Image" class="w-100">
                                    <a href="assets/img/widget/gal-1-4-big.jpg" class="popup-image gal-btn"><i
                                            class="fal fa-plus"></i></a>
                                </div>
                                <div class="gallery-thumb">
                                    <img src="assets/img/widget/gal-1-5.jpg" alt="Gallery Image" class="w-100">
                                    <a href="assets/img/widget/gal-1-5-big.jpg" class="popup-image gal-btn"><i
                                            class="fal fa-plus"></i></a>
                                </div>
                                <div class="gallery-thumb">
                                    <img src="assets/img/widget/gal-1-6.jpg" alt="Gallery Image" class="w-100">
                                    <a href="assets/img/widget/gal-1-6-big.jpg" class="popup-image gal-btn"><i
                                            class="fal fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="vs-footer__bottom bg-theme-color-1">
            <div class="container">
                <div
                    class="row gy-3 gx-5 align-items-center justify-content-center justify-content-lg-between flex-column-reverse flex-lg-row">
                    <div class="col-md-auto">
                        <p class="vs-footer__copyright mb-0">
                            Copyright © <span id="currentYear"></span>
                            <a href="http://html.vecurosoft.com/toddly">Toddly</a>. All rights reserved
                            By <a href="https://themeforest.net/user/vecuro_themes">Vecuro</a>.
                        </p>
                    </div>
                    <div class="col-md-auto">
